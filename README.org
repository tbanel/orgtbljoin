...
The parameter after =:mas-table= or =:ref-table= may be:
...
for OrgtblJoin. This is because in this case the Babel script
...
In any case, the columns may be referenced as =$1, $2, $3, …= as usual.
...
#+begin_src js
[
  ["day","quty","color"],   // names of columns in the header
  [],                       // an horizontal line
  ["mon",12,"red"  ],
  ["thu",34,"blue" ],
  …
