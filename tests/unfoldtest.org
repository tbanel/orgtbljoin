...
(orgtbl-join-unfold-test
 "C-a <right> <tab>"
 "<down> <tab> u n i t t e <tab> M-b M-b C-SPC C-a <delete> <return>"
 "<down> <tab> c o l o <tab> <return>"
 "<down> <down> <down> <down> <tab> n <tab> <return>"
 "<down> <tab> u n i t t e s <tab> M-b M-b C-SPC C-a <backspace> <return>"
 "<down> <tab> 1 2 <tab> <return>"
 "<down> <down> <down> <down> <tab> c o <tab> <return>"
 "<down> <tab> <end> C-a M-f M-f C-k <tab>"
 "<down> <down> <up> <tab> <return>"
 "<down> <tab> <return>"
 "<down> <tab>"
 "<up> <up> <up> <up> <up> <up> <up> <up> <up> <up> <up> <up> <up> <up> <up> <up> <left> <left> <left> <tab>"
 "C-a C-c C-c"
 ))
#+end_src
